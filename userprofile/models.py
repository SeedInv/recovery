...
class UserProfile(models.Model):
    ...
    updated_at = models.DateTimeField(auto_now=True)      # Timestamp whenever the profile is updated
    ...
    def __str__(self):
        return f"User: {self.user.username}, Email: {self.user.email}, Phone: {self.phone_number}, " \
               ...
               f"Balance: {self.balance}, Created At: {self.created_at}, Updated At: {self.updated_at}"
